...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv3 = nn.Conv2d(planes, planes*Bottleneck.expansion, kernel_size=1, stride=stride)
        self.bn3 = nn.BatchNorm2d(planes*Bottleneck.expansion, momentum=BN_MOMENTUM)
        self.relu = nn.ReLU()
        ####################################
        ####################################
        ####################################
...
class ResNet(nn.Module):
    ...
    def __init__(self, block=Bottleneck, num_maps=10, layers=[3,4,6,3]):
        ...
        ####### ENTER YOUR CODE HERE #######
        ####################################
        self.deconv_layers_1 = self._make_deconv_layer(0, [256]*3, [4]*3)
        self.deconv_layers_2 = self._make_deconv_layer(1, [256]*3, [4]*3)
        self.deconv_layers_3 = self._make_deconv_layer(2, [256]*3, [4]*3)
        ####################################
        ####################################
        ####################################
